...
<body>
		...
		<form action="/updateMember" method="post" id="mypage">
			...
			<div id="btn-box">
				...
				<c:if test="${m.memberId eq 'admin' }">
					<button class="btn btn-outline-danger btn-lg" type="button" onclick="allMember('${m.memberId }')" >회원관리</button>
				</c:if> 
	...
	<script>
		...
		function allMember(memberId){
				location.href="/adminPage?memberId="+memberId;
