	...
	<section class="container">
		<form action="/updateNotice" method="post" enctype="multipart/form-data" id="updateFrm">
			...
			<table class="table table-bordered">
				...
				<tr>
					<th>제목</th>
					<td><input type="text" class="form-control" name="noticeTitle" value="${n.noticeTitle }"></td>
				</tr>
				...
				<tr>
					<th>내용</th>
					<td><textarea rows="3" name="noticeContent" style="width:100%;">${n.noticeContent }</textarea></td>
				</tr>
