...
<script src="https://openapi.map.naver.com/openapi/v3/maps.js?ncpClientId=3h2qh90mw3&submodules=geocoder"></script>
	...
	<section class="container">
		...
		<ul>
			<li>
				...
				<button id="addrSearchBtn" onclick="addrSearch();" class="btn btn-primary">주소찾기</button>
			</li>
	...
	<script>
		...
		window.onload=function(){
			...
			var contentString = [
				"<div class='iw_inner'>",
				"<h3>KH정보교육원</h3>",
				"<p>서울시 영등포구 선유도2동 57 이레빌딩 19F</p>",
				"</div>"
			].join("");
